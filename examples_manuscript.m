...
tol_zero = 1e-5; % numerical tolerance: if x <= tol, then x = 0
...
[Jmin,minCond,alphaMin,coneMin,nfevals,unpruned,vstar,Dfinish] = isConvexFullRank(A,maxD,tol_zero,epsilon)
